        ...
        <div className="max-w-2xl">
          ...
          >
            <Button 
                ...
                className="bg-primary text-black hover:bg-primary/90 text-lg px-8 font-heading font-bold uppercase tracking-wide cursor-pointer"
            >
                Shop Now
            </Button>
            ...
            <Button 
                ...
                className="border-white text-white hover:bg-white hover:text-black text-lg px-8 font-heading font-bold uppercase tracking-wide group cursor-pointer"
            >
                Join the Club
